defmodule CoreWeb.Router do
  ...
  if Application.compile_env(:guide_to_payments, :dev_routes) do
  ...
  scope "/", CoreWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{CoreWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", CoreWeb do
    ...
    live_session :current_user,
      on_mount: [{CoreWeb.UserAuth, :mount_current_user}] do
